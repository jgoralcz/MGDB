...
with open(now+".sql", 'a') as sql_file:
    ...
    for i in range(1, length):
        ...
        sql_file.write(ins.insert("Games", "NULL, %d, %d, '%s', '%s', '%s', '%s'") % (i+engine_offset, i+series_offset, pop.random_string(1000), pop.random_string(64),  pop.random_string(64),  pop.random_string(256)))
    sql_file.write("\n")
