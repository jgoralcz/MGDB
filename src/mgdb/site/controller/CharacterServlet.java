...
import mgdb.site.handler.CharactersHandler;
...
public class CharacterServlet extends HttpServlet {
	...
	private static Logger log = Logger.getLogger(CharactersHandler.class.getName());
    ...
    public void init(ServletConfig config) throws ServletException {
		...
		// add to handler
		handlers.put("search", new CharactersHandler());
		
		// pages too
		pageViews.put("/", "/index.html");
		pageViews.put("charactersHome", "/characters.html");
...
//		String forwardPage = errorPage;
		String forwardPage = pageViews.get("charactersHome");
